...
#  Дипломная работа по профессии «Системный администратор» - Сайфиев Денис
...
### 1.1. Скачивание Terraform 1.10.5, распаковка, перемещение в директорию, выдача прав (766), проверка версии.
   ...
   ![2.](https://github.com/DenioSa/sys-D-SD/blob/a130e19eeaa60107dd7475f798e61cc223fba2e6/img/Terraform%202.png)
...
### По средствам плейбук на виртуальной машине WS-Z был развернут Zabbix, а так же на серверах WS1-WS2 поднят Zabbix Agent. Настройка WS1-WS2 на отправку метрик Zabbix server (WS-Z). Настроены дашборды с метриками.
  ...
  ![28.](https://github.com/DenioSa/sys-D-SD/blob/64789bb93e97ae99b33645ddfdd3a68c6033a621/img/Z5.png)

### В процессе установки инструментов и дополнений необходимо экспериментировать с версиями, т.к. при более старых вероятны ошибки.
...
### Filebeat наиболее стабильны последние версии. При более ранних проблемы с запуском.
...
## Сеть
  ...
  ## Резерная копия
   ...
   #  Доработка дипломной «Системный администратор»

   Согласно замечанию дипломного руководителя ранее действовавший токен отозван в личном кабинете. Далее согласно документации назначены роли и проведена инициализация авторизированного ключа для сервичсного аккаунта. Данные по токену и авторизированному ключу внесены в конфигурационный файл main.tf (перезалит в репозиторий), далее проверил по 2-м вариациям в terraform plan. По итогам проверки преподавателем токен, ключ ssh и другие данные по облаку будут удалены из дипломной.
   ...
   ![50.](https://github.com/DenioSa/sys-D-SD/blob/367de3c344e7cb6035d4e37e6ef97f1c2bef34ea/img/D6.png)
